                    ...
                    <div class="rating-wrapper">
                        <ul v-show="food.ratings">
                            <li v-show="needShow(rating.rateType, rating.text)" v-for="rating in food.ratings" class="rating-item">
                                ...
                                <p class="text">
                                    <span :class="{'icon-thumb_up':rating.rateType===0,'icon-thumb_down':rating.rateType===1}">A</span>{{rating.text}}
                                </p>
                            </li>
                        </ul>
...
<script type="text/ecmascript-6">
    ...
    export default {
        ...
        mounted() {
            bus.$on('ratingtype.select', function (type) {
                this.selectType = type;
                this.$nextTick(() => {
                    this.scroll.refresh();
                });
            });
            bus.$on('content.toggle', function (onlyContent) {
