<template>
    <div>
                    ...
                    <li v-for="item in goods" class="food-list food-list-hook">
                        ...
                        <ul>
                            <li @click="selectedFood(food, $event)" v-for="food in item.foods" class="food-item">
                                <div class="icon">
                                    <img :src="food.icon" width="57px" height="57px" class="icon-img">
                                </div>
                                <div class="content">
        ...
        <div>
            <food :food="selectFood" class="food" ref="foodComponent"></food>
        </div>
    </div>
</template>
...
//    import Vue from 'Vue';
    ...
    export default {
        ...
        mounted() {
            bus.$on('sendSellerEventBus', function (msg) {
                this.seller = msg;
            });
            bus.$on('sendFoodCountEventBus', function (count) {
//                console.log(count);
